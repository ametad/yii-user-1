...
class RegistrationForm extends User {
	...
	public function rules() {
		$rules = array(
			...
			array('password', 'match', 'pattern'=>'/^\w*(?=\w*\d)(?=\w*[a-z])(?=\w*[A-Z])\w*$/', 'message' => UserModule::t("Password must contain at least one digit, one uppercase letter and one lowercase letter.")),
			array('email', 'email'),
